...
static u32 HandleRegionMapInput(struct Pokenav_RegionMapMenu *state)
{
    ...
    case MAP_INPUT_A_BUTTON:
        if(regionMap->mapSecType == MAPSECTYPE_CITY_CANFLY && FlagGet(FLAG_BADGE04_GET) && !FlagGet(FLAG_EGR_NO_FLY) && Overworld_MapTypeAllowsTeleportAndFly(gMapHeader.mapType)) {
