...
static const struct InGameTrade sIngameTrades[] =
{
    ...
    [INGAME_TRADE_LYOLICA] =
    {
        .nickname = _("Lyolica"),
        .species = SPECIES_LYOLICA,
        .ivs = {31, 31, 31, 31, 31, 31},
        .abilityNum = 2,
        .otId = 91481,
        .conditions = {5, 5, 5, 30, 5},
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_LYORESA
    },
    [INGAME_TRADE_SHISHIMA_ALT] =
    {
        .nickname = _("Shishima"),
        .species = SPECIES_SHISHIMA_ALT,
        .ivs = {31, 31, 31, 31, 31, 31},
        .abilityNum = 0,
        .otId = 91481,
        .conditions = {5, 5, 5, 30, 5},
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_SHISHIMA
    }
};
