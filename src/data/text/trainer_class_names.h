const u8 gTrainerClassNames[][18] = {
    ...
    [TRAINER_CLASS_ELITE_FOUR] = _("Topaz Deacon"),
    ...
    [TRAINER_CLASS_CHAMPION] = _("{PKMN} Master"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = _("Ozone's Finest"),
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = _("Harbinger"), //Wally
