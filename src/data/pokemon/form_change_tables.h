...
static const struct FormChange sGaoterraFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_GAOTERRA_SOLAR,  SPLIT_PHYSICAL, ABILITY_STELLAR_BODY},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_GAOTERRA_LUNAR,  SPLIT_SPECIAL,  ABILITY_STELLAR_BODY},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_GAOTERRA,        SPLIT_STATUS,   ABILITY_STELLAR_BODY},
