...
const u8 gMonFootprint_Cremeletts[] = INCBIN_U8("graphics/pokemon/000rarities/scarce.1bpp");
...
const u8 gMonFootprint_Spitfax[] = INCBIN_U8("graphics/pokemon/000rarities/mystic.1bpp");
