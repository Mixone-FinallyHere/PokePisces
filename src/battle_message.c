...
static const u8 sText_PkmnMakesPoisonMiss[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} makes\n{B_BUFF1} moves ineffective!");
static const u8 sText_PkmnMakesIsEmpty[] = _("{B_DEF_NAME_WITH_PREFIX} is {B_DEF_ABILITY}...");
...
static const u8 sText_PkmnFrostbiteBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1}\ngave {B_EFF_NAME_WITH_PREFIX} frostbite!");
...
static const u8 sText_GainedAStackOfStormBrew[] = _("{B_ATK_NAME_WITH_PREFIX} gained a\nstack of Storm Brew!");
...
static const u8 sText_UsingItemTheStatOfTargetPkmnRose[] = _("Using {B_LAST_ITEM}, the {B_BUFF1}\nof {B_DEF_NAME_WITH_PREFIX} {B_BUFF2}");
static const u8 sText_FlipCoinMessage[] = _("Using {B_LAST_ITEM}, {B_ATK_NAME_WITH_PREFIX}\nflipped {B_DEF_NAME_WITH_PREFIX}'s stat buffs!");
...
static const u8 sText_GotchaPkmnCaughtPlayerNoMusic[] = _("Gotcha!\n{B_DEF_NAME} was caught!{WAIT_SE}\p");
...
static const u8 sText_PkmnSurroundedWithVeils[] = _("{B_LAST_ITEM} surrounded\n{B_DEF_NAME_WITH_PREFIX} with a veil of water!");
...
static const u8 sText_SuperAnticipationActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is anticipating\na strong attack!");
...
static const u8 sText_AttackerBecameWeakerToFire[] = _("{B_LAST_ITEM} made\n{B_ATK_NAME_WITH_PREFIX} weaker to fire!");
...
static const u8 sText_AbilityEntranced[] = _("All opponents are entranced by\n{B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnGemstoneMaxedEvasion[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nboosted its evasiveness!");
static const u8 sText_PkmnGemstoneLostEvasion[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nlowered its evasiveness.");
...
static const u8 sText_UserGainedDaybreak[] = _("{B_ATK_NAME_WITH_PREFIX} is at {B_BUFF1} daybreak,\nempowering offenses and defenses,\lbut sacrificing HP!");
static const u8 sText_UserHasEnteredAFrenzy[] = _("{B_ATK_NAME_WITH_PREFIX} is at {B_BUFF1} frenzy,\nempowering Speed and critical\lhits, but hindering defenses!");
...
static const u8 sText_MagmaArmored[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} hardened\nfrom {B_ATK_NAME_WITH_PREFIX}'s attack!");
...
static const u8 sText_UserHasExhaustion[] = _("{B_ATK_NAME_WITH_PREFIX} gained a\nstack of exhaustion, putting\lit at {B_BUFF1}, hindering offenses!");
static const u8 sText_TargetIsExhausted[] = _("{B_DEF_NAME_WITH_PREFIX} gained a\nstack of exhaustion, putting\lit at {B_BUFF1}, hindering offenses!");
static const u8 sText_SuperMagnetNoStatLoss[] = _("{B_ATK_NAME_WITH_PREFIX}'s super-charged Magnet\nRise prevented stat loss!");
static const u8 sText_TargetBecomesSupercharged[] = _("{B_DEF_NAME_WITH_PREFIX} became Super-charged,\nempowering Electric-type moves!");
static const u8 sText_TargetBecomesGearedUp[] = _("{B_DEF_NAME_WITH_PREFIX} became Geared Up,\nempowering Steel-type moves!");
static const u8 sText_UserGainsPhantom[] = _("{B_ATK_NAME_WITH_PREFIX} became a phantom,\nempowering speed, critical hits,\land evasiveness!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_WEPEARHEALBLOCKPKMN - BATTLESTRINGS_TABLE_START] = sText_WepearHealBlockPkmn,
    [STRINGID_NANABMINIMIZE - BATTLESTRINGS_TABLE_START] = sText_NanabMinimize,
    ...
    [STRINGID_SUPERANTICIPATIONACTIVATES - BATTLESTRINGS_TABLE_START] = sText_SuperAnticipationActivates,
    ...
    [STRINGID_CLOUDNINEACTIVATES - BATTLESTRINGS_TABLE_START] = sText_CloudNineActivates,
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_SUPER_ANTICIPATION] = STRINGID_SUPERANTICIPATIONACTIVATES,
...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_SPECIAL_MISS] = STRINGID_PKMNMAKESPOISONMISS,
...
const u16 gGotFrostbiteStringIds[] =
{
    ...
    [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNFROSTBITEBY
};
