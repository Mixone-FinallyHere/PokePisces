...
static const u8 sText_WepearIdentifiedPkmn[] = _("{B_ATK_NAME_WITH_PREFIX} was\nidentified by {B_LAST_ITEM}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_WEPEARIDENTIFIEDPKMN - BATTLESTRINGS_TABLE_START] = sText_WepearIdentifiedPkmn,
