...
#define MAP_GROUP_PISCES_MAJOR_1 MAP_GROUP(SS_TIDAL_EXTERIOR)
#define MAP_GROUP_PISCES_MAJOR_2 MAP_GROUP(CAVE_OF_ORIGIN)
#define MAP_GROUP_PISCES_MAJOR_3 MAP_GROUP(NEW_SUNBEACH)
#define MAP_GROUP_PISCES_MAJOR_4 MAP_GROUP(THE_COLD_MINES)
#define MAP_GROUP_PISCES_MAJOR_5 MAP_GROUP(SCUTTILL_HUTS)
#define MAP_GROUP_PISCES_MAJOR_6 MAP_GROUP(OZONE_INSTITUTE)
#define MAP_GROUP_PISCES_MAJOR_7 MAP_GROUP(SWELTORN_DESERT)
#define MAP_GROUP_PISCES_MAJOR_8 MAP_GROUP(SLATEPORT_SHORE)
#define MAP_GROUP_PISCES_MAJOR_9 MAP_GROUP(DETERMANITE_BEACH)
#define MAP_GROUP_PISCES_MAJOR_10 MAP_GROUP(PETALBURG_NEW)
#define MAP_GROUP_PISCES_MAJOR_11 MAP_GROUP(CRIMNEY_CALDERA)
    ...
    if (species != roamer->species)
    {
        ...
        for (i = 0; gWildMonHeaders[i].mapGroup != MAP_GROUP(UNDEFINED); i++)
        {
            if (MapHasSpecies(&gWildMonHeaders[i], species))
            {
                ...
                {
                case MAP_GROUP_TOWNS_AND_ROUTES:
                case MAP_GROUP_PISCES_MAJOR_1:
                case MAP_GROUP_PISCES_MAJOR_2:
                case MAP_GROUP_PISCES_MAJOR_3:
                case MAP_GROUP_PISCES_MAJOR_4:
                case MAP_GROUP_PISCES_MAJOR_5:
                case MAP_GROUP_PISCES_MAJOR_6:
                case MAP_GROUP_PISCES_MAJOR_7:
                case MAP_GROUP_PISCES_MAJOR_8:
                case MAP_GROUP_PISCES_MAJOR_9:
                case MAP_GROUP_PISCES_MAJOR_10:
                case MAP_GROUP_PISCES_MAJOR_11:
