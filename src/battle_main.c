...
{
    {TRAINER_CLASS_TEAM_AQUA, 20},
    {TRAINER_CLASS_AQUA_ADMIN, 40},
    {TRAINER_CLASS_AQUA_LEADER, 50},
    {TRAINER_CLASS_AROMA_LADY, 30},
    ...
    {TRAINER_CLASS_COOLTRAINER, 40},
    {TRAINER_CLASS_ACE_TRAINER, 40},
    {TRAINER_CLASS_HEX_MANIAC, 10},
    {TRAINER_CLASS_LADY, 50},
    {TRAINER_CLASS_BEAUTY, 30},
    {TRAINER_CLASS_RICH_BOY, 50},
    {TRAINER_CLASS_POKEMANIAC, 40},
    {TRAINER_CLASS_SWIMMER_M, 30},
    {TRAINER_CLASS_BLACK_BELT, 30},
    {TRAINER_CLASS_GUITARIST, 20},
    {TRAINER_CLASS_KINDLER, 20},
    {TRAINER_CLASS_CAMPER, 5},
    {TRAINER_CLASS_OLD_COUPLE, 30},
    ...
    {TRAINER_CLASS_POKEFAN, 30},
    {TRAINER_CLASS_EXPERT, 40},
    {TRAINER_CLASS_YOUNGSTER, 5},
    {TRAINER_CLASS_CHAMPION, 50},
    {TRAINER_CLASS_FISHERMAN, 10},
    {TRAINER_CLASS_TRIATHLETE, 30},
    {TRAINER_CLASS_DRAGON_TAMER, 30},
    {TRAINER_CLASS_BIRD_KEEPER, 30},
    {TRAINER_CLASS_NINJA_BOY, 5},
    {TRAINER_CLASS_BATTLE_GIRL, 30},
    {TRAINER_CLASS_PARASOL_LADY, 30},
    {TRAINER_CLASS_SWIMMER_F, 30},
    {TRAINER_CLASS_PICNICKER, 5},
    {TRAINER_CLASS_TWINS, 5},
    {TRAINER_CLASS_SAILOR, 20},
    {TRAINER_CLASS_COLLECTOR, 40},
    {TRAINER_CLASS_RIVAL, 40},
    {TRAINER_CLASS_PKMN_BREEDER, 20},
    {TRAINER_CLASS_PKMN_RANGER, 20},
    {TRAINER_CLASS_TEAM_MAGMA, 20},
    {TRAINER_CLASS_MAGMA_ADMIN, 40},
    {TRAINER_CLASS_MAGMA_LEADER, 50},
    {TRAINER_CLASS_LASS, 5},
    {TRAINER_CLASS_BUG_CATCHER, 5},
    {TRAINER_CLASS_HIKER, 30},
    {TRAINER_CLASS_YOUNG_COUPLE, 10},
    {TRAINER_CLASS_WINSTRATE, 30},
    {TRAINER_CLASS_GILDED_MONK, 50},
    {TRAINER_CLASS_TOPAZ_ACOLYTE, 50},
    {TRAINER_CLASS_DEMOLITIONIST, 1},
    {TRAINER_CLASS_SCUBA_DIVER, 30},
    {TRAINER_CLASS_FREE_DIVER, 30},
    {TRAINER_CLASS_SHRINE_MAIDEN, 20},
    {TRAINER_CLASS_STREET_THUG, 10},
    {TRAINER_CLASS_ELECTRICIAN, 20},
    {TRAINER_CLASS_YOU_TUBER, 50},
    {TRAINER_CLASS_HARDHATTER, 20},
    {TRAINER_CLASS_MECHANIC, 20},
    {TRAINER_CLASS_CLIMBER, 30},
    {TRAINER_CLASS_RUIN_HUNTER, 30},
    {TRAINER_CLASS_ANGLER, 10},
    {TRAINER_CLASS_FAIRYTALE_GIRL, 5},
    {TRAINER_CLASS_WAYFARER, 20},
    {TRAINER_CLASS_CHEERLEADERS, 10},
    {TRAINER_CLASS_POKE_FREAK, 30},
    {TRAINER_CLASS_GAMBLER, 10},
    {TRAINER_CLASS_BREADWINNER, 20},
    {TRAINER_CLASS_BASSIST, 20},
    {TRAINER_CLASS_SEA_SHELLER, 5},
    {TRAINER_CLASS_SNOW_CHILD, 5},
    {TRAINER_CLASS_SNOW_KID, 5},
    {TRAINER_CLASS_SKIER, 30},
    {TRAINER_CLASS_ESPER, 10},
    {TRAINER_CLASS_BURGLAR, 50},
    {TRAINER_CLASS_KUNOICHI, 30},
    {TRAINER_CLASS_MEDIUM, 20},
    {TRAINER_CLASS_MADAME, 50},
    {TRAINER_CLASS_BIRD_WATCHER, 5},
    {TRAINER_CLASS_COURIER, 20},
    {TRAINER_CLASS_HUNTER, 20},
    {TRAINER_CLASS_LANDSCAPERS, 20},
    {TRAINER_CLASS_GO_GETTER, 40},
    {TRAINER_CLASS_UPSTART, 40},
    {TRAINER_CLASS_JANITOR, 20},
    {TRAINER_CLASS_RESEARCHER, 20},
    {TRAINER_CLASS_SCIENTIST, 20},
    {TRAINER_CLASS_DRAGON_CALLER, 30},
    {TRAINER_CLASS_ICE_POPS, 20},
    {TRAINER_CLASS_KLUTZ, 10},
    {TRAINER_CLASS_DRAGON_RIDER, 30},
    {TRAINER_CLASS_WALTZER, 30},
    {TRAINER_CLASS_DANCER, 30},
    {TRAINER_CLASS_ANGY_WANGY, 10},
    {TRAINER_CLASS_DELINQUENT, 10},
    {TRAINER_CLASS_PAPER_BOY, 10},
    {TRAINER_CLASS_MONK, 1},
    {TRAINER_CLASS_MASTER, 40},
    {TRAINER_CLASS_PLUMBER, 20},
    {TRAINER_CLASS_METEOROLOGISTS, 20},
    {TRAINER_CLASS_VANDAL, 5},
    {TRAINER_CLASS_CLOWN, 20},
    {TRAINER_CLASS_CHARMER, 30},
    {TRAINER_CLASS_MOGUL, 50},
    {TRAINER_CLASS_MARCHONESS, 50},
    {TRAINER_CLASS_PROFITEER, 50},
    {TRAINER_CLASS_NURSE, 20},
    {TRAINER_CLASS_PKMN_RANCHER, 20},
    {0xFF, 30}, // Any trainer class not listed above uses this
};
