...
#define TRAINER_CHILD 6
#define TRAINER_POOR 12
#define TRAINER_WORKING 24
#define TRAINER_MIDDLE 34
#define TRAINER_UPPER 38
#define TRAINER_RICH 45

// This is a factor in how much money you get for beating a trainer.
const struct TrainerMoney gTrainerMoneyTable[] =
{
    {TRAINER_CLASS_TEAM_AQUA, TRAINER_WORKING},
    {TRAINER_CLASS_AQUA_ADMIN, TRAINER_UPPER},
    {TRAINER_CLASS_AQUA_LEADER, TRAINER_RICH},
    {TRAINER_CLASS_AROMA_LADY, TRAINER_MIDDLE},
    {TRAINER_CLASS_RUIN_MANIAC, TRAINER_MIDDLE},
    {TRAINER_CLASS_INTERVIEWER, TRAINER_WORKING},
    {TRAINER_CLASS_TUBER_F, TRAINER_CHILD},
    {TRAINER_CLASS_TUBER_M, TRAINER_CHILD},
    {TRAINER_CLASS_SIS_AND_BRO, TRAINER_POOR},
    {TRAINER_CLASS_COOLTRAINER, TRAINER_UPPER},
    {TRAINER_CLASS_ACE_TRAINER, TRAINER_UPPER},
    {TRAINER_CLASS_HEX_MANIAC, TRAINER_POOR},
    {TRAINER_CLASS_LADY, TRAINER_RICH},
    {TRAINER_CLASS_BEAUTY, TRAINER_MIDDLE},
    {TRAINER_CLASS_RICH_BOY, TRAINER_RICH},
    {TRAINER_CLASS_POKEMANIAC, TRAINER_UPPER},
    {TRAINER_CLASS_SWIMMER_M, TRAINER_MIDDLE},
    {TRAINER_CLASS_BLACK_BELT, TRAINER_MIDDLE},
    {TRAINER_CLASS_GUITARIST, TRAINER_WORKING},
    {TRAINER_CLASS_KINDLER, TRAINER_WORKING},
    {TRAINER_CLASS_CAMPER, TRAINER_CHILD},
    {TRAINER_CLASS_OLD_COUPLE, TRAINER_MIDDLE},
    {TRAINER_CLASS_BUG_MANIAC, TRAINER_POOR},
    {TRAINER_CLASS_PSYCHIC, TRAINER_POOR},
    {TRAINER_CLASS_GENTLEMAN, TRAINER_UPPER},
    {TRAINER_CLASS_ELITE_FOUR, TRAINER_UPPER},
    {TRAINER_CLASS_LEADER, TRAINER_UPPER},
    {TRAINER_CLASS_SCHOOL_KID, TRAINER_POOR},
    {TRAINER_CLASS_SR_AND_JR, TRAINER_POOR},
    {TRAINER_CLASS_POKEFAN, TRAINER_MIDDLE},
    {TRAINER_CLASS_EXPERT, TRAINER_UPPER},
    {TRAINER_CLASS_YOUNGSTER, TRAINER_CHILD},
    {TRAINER_CLASS_CHAMPION, TRAINER_RICH},
    {TRAINER_CLASS_FISHERMAN, TRAINER_POOR},
    {TRAINER_CLASS_TRIATHLETE, TRAINER_MIDDLE},
    {TRAINER_CLASS_DRAGON_TAMER, TRAINER_MIDDLE},
    {TRAINER_CLASS_BIRD_KEEPER, TRAINER_MIDDLE},
    {TRAINER_CLASS_NINJA_BOY, TRAINER_CHILD},
    {TRAINER_CLASS_BATTLE_GIRL, TRAINER_MIDDLE},
    {TRAINER_CLASS_PARASOL_LADY, TRAINER_MIDDLE},
    {TRAINER_CLASS_SWIMMER_F, TRAINER_MIDDLE},
    {TRAINER_CLASS_PICNICKER, TRAINER_CHILD},
    {TRAINER_CLASS_TWINS, TRAINER_CHILD},
    {TRAINER_CLASS_SAILOR, TRAINER_WORKING},
    {TRAINER_CLASS_COLLECTOR, TRAINER_UPPER},
    {TRAINER_CLASS_RIVAL, TRAINER_UPPER},
    {TRAINER_CLASS_PKMN_BREEDER, TRAINER_WORKING},
    {TRAINER_CLASS_PKMN_RANGER, TRAINER_WORKING},
    {TRAINER_CLASS_TEAM_MAGMA, TRAINER_WORKING},
    {TRAINER_CLASS_MAGMA_ADMIN, TRAINER_UPPER},
    {TRAINER_CLASS_MAGMA_LEADER, TRAINER_RICH},
    {TRAINER_CLASS_LASS, TRAINER_CHILD},
    {TRAINER_CLASS_BUG_CATCHER, TRAINER_CHILD},
    {TRAINER_CLASS_HIKER, TRAINER_MIDDLE},
    {TRAINER_CLASS_YOUNG_COUPLE, TRAINER_POOR},
    {TRAINER_CLASS_WINSTRATE, TRAINER_MIDDLE},
    {TRAINER_CLASS_GILDED_MONK, TRAINER_RICH},
    {TRAINER_CLASS_TOPAZ_ACOLYTE, TRAINER_RICH},
    {TRAINER_CLASS_DEMOLITIONIST, 1},
    {TRAINER_CLASS_SCUBA_DIVER, TRAINER_MIDDLE},
    {TRAINER_CLASS_FREE_DIVER, TRAINER_MIDDLE},
    {TRAINER_CLASS_SHRINE_MAIDEN, TRAINER_WORKING},
    {TRAINER_CLASS_STREET_THUG, TRAINER_POOR},
    {TRAINER_CLASS_ELECTRICIAN, TRAINER_WORKING},
    {TRAINER_CLASS_YOU_TUBER, TRAINER_RICH},
    {TRAINER_CLASS_HARDHATTER, TRAINER_WORKING},
    {TRAINER_CLASS_MECHANIC, TRAINER_WORKING},
    {TRAINER_CLASS_CLIMBER, TRAINER_MIDDLE},
    {TRAINER_CLASS_RUIN_HUNTER, TRAINER_MIDDLE},
    {TRAINER_CLASS_ANGLER, TRAINER_POOR},
    {TRAINER_CLASS_FAIRYTALE_GIRL, TRAINER_CHILD},
    {TRAINER_CLASS_WAYFARER, TRAINER_WORKING},
    {TRAINER_CLASS_CHEERLEADERS, TRAINER_POOR},
    {TRAINER_CLASS_POKE_FREAK, TRAINER_MIDDLE},
    {TRAINER_CLASS_GAMBLER, TRAINER_POOR},
    {TRAINER_CLASS_BREADWINNER, TRAINER_WORKING},
    {TRAINER_CLASS_BASSIST, TRAINER_WORKING},
    {TRAINER_CLASS_SEA_SHELLER, TRAINER_CHILD},
    {TRAINER_CLASS_SNOW_CHILD, TRAINER_CHILD},
    {TRAINER_CLASS_SNOW_KID, TRAINER_CHILD},
    {TRAINER_CLASS_SKIER, TRAINER_MIDDLE},
    {TRAINER_CLASS_ESPER, TRAINER_POOR},
    {TRAINER_CLASS_BURGLAR, TRAINER_RICH},
    {TRAINER_CLASS_KUNOICHI, TRAINER_MIDDLE},
    {TRAINER_CLASS_MEDIUM, TRAINER_WORKING},
    {TRAINER_CLASS_MADAME, TRAINER_RICH},
    {TRAINER_CLASS_BIRD_WATCHER, TRAINER_CHILD},
    {TRAINER_CLASS_COURIER, TRAINER_WORKING},
    {TRAINER_CLASS_HUNTER, TRAINER_WORKING},
    {TRAINER_CLASS_LANDSCAPERS, TRAINER_WORKING},
    {TRAINER_CLASS_GO_GETTER, TRAINER_UPPER},
    {TRAINER_CLASS_UPSTART, TRAINER_UPPER},
    {TRAINER_CLASS_JANITOR, TRAINER_WORKING},
    {TRAINER_CLASS_RESEARCHER, TRAINER_WORKING},
    {TRAINER_CLASS_SCIENTIST, TRAINER_WORKING},
    {TRAINER_CLASS_DRAGON_CALLER, TRAINER_MIDDLE},
    {TRAINER_CLASS_ICE_POPS, TRAINER_WORKING},
    {TRAINER_CLASS_KLUTZ, TRAINER_POOR},
    {TRAINER_CLASS_DRAGON_RIDER, TRAINER_MIDDLE},
    {TRAINER_CLASS_WALTZER, TRAINER_MIDDLE},
    {TRAINER_CLASS_DANCER, TRAINER_MIDDLE},
    {TRAINER_CLASS_ANGY_WANGY, TRAINER_POOR},
    {TRAINER_CLASS_DELINQUENT, TRAINER_POOR},
    {TRAINER_CLASS_PAPER_BOY, TRAINER_POOR},
    {TRAINER_CLASS_MONK, 1},
    {TRAINER_CLASS_MASTER, TRAINER_UPPER},
    {TRAINER_CLASS_PLUMBER, TRAINER_WORKING},
    {TRAINER_CLASS_METEOROLOGISTS, TRAINER_WORKING},
    {TRAINER_CLASS_VANDAL, TRAINER_CHILD},
    {TRAINER_CLASS_CLOWN, TRAINER_WORKING},
    {TRAINER_CLASS_CHARMER, TRAINER_MIDDLE},
    {TRAINER_CLASS_MOGUL, TRAINER_RICH},
    {TRAINER_CLASS_MARCHONESS, TRAINER_RICH},
    {TRAINER_CLASS_PROFITEER, TRAINER_RICH},
    {TRAINER_CLASS_NURSE, TRAINER_WORKING},
    {TRAINER_CLASS_PKMN_RANCHER, TRAINER_WORKING},
    {0xFF, TRAINER_MIDDLE}, // Any trainer class not listed above uses this
};
