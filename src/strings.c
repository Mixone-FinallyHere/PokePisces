...
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} likes you less...{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAdoresBaseVar2Fell[] = _("{STR_VAR_1} hates you...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokenavMap_ZoomedOutButtons[] = _("{B_BUTTON}CANCEL");
const u8 gText_PokenavMap_CanFlyButtons[] = _("{A_BUTTON}FLY {B_BUTTON}CANCEL");
...
const u8 gText_Abilities[] = _("{STR_VAR_1}\n{STR_VAR_2}\n{STR_VAR_3}");
