...
extern const u8 BattleScript_LocalBattleLostGym[];
...
extern const u8 BattleScript_PomegBerryInvertReturn[];
extern const u8 BattleScript_PomegBerryInvertEnd2[];
...
extern const u8 BattleScript_LongNose[];
...
extern const u8 BattleScript_MoveEffectTicked[];
...
extern const u8 BattleScript_StickyHoldActivatesMagician[];
extern const u8 BattleScript_ColorChangeActivates[];
extern const u8 BattleScript_ReformActivates[];
extern const u8 BattleScript_RoughSkinActivates[];
extern const u8 BattleScript_CuteCharmInfatuationActivates[];
extern const u8 BattleScript_CuteCharmInfatuationActivates2[];
extern const u8 BattleScript_CuteCharmAllureActivates[];
extern const u8 BattleScript_CuteCharmAllureActivates2[];
extern const u8 BattleScript_LovesickActivates[];
...
extern const u8 BattleScript_HondewBerryActivatesReturn[];
extern const u8 BattleScript_HondewBerryActivatesEnd2[];
extern const u8 BattleScript_YellowSodaActivatesReturn[];
extern const u8 BattleScript_YellowSodaActivatesEnd2[];
extern const u8 BattleScript_CheeseActivatesReturn[];
extern const u8 BattleScript_CheeseActivatesEnd2[];
extern const u8 BattleScript_FrothyCheeseActivatesReturn[];
extern const u8 BattleScript_FrothyCheeseActivatesEnd2[];
...
extern const u8 BattleScript_DrySkinHealStatUp[];
extern const u8 BattleScript_DrySkinHealStatUp_PPLoss[];
extern const u8 BattleScript_WindPowerCharge[];
extern const u8 BattleScript_WindPowerCharge_PPLoss[];
...
extern const u8 BattleScript_SolarPowerActivatesSunEveryone[];
...
extern const u8 BattleScript_HeartCarveHealHP[];
...
extern const u8 BattleScript_SelectingNotAllowedMovePhantom[];
...
extern const u8 BattleScript_StickyBarbJustSpikes[];
extern const u8 BattleScript_HeartGiftSurpriseCount[];
extern const u8 BattleScript_HeartGiftSurpriseFulfilled[];
...
extern const u8 BattleScript_StormBrewActivates[];
...
extern const u8 BattleScript_AnnounceCloudNine[];
extern const u8 BattleScript_AnnounceAirLock[];
...
extern const u8 BattleScript_SunriseActivates[];
extern const u8 BattleScript_DelugeActivates[];
extern const u8 BattleScript_DelugeHurts[];
...
extern const u8 BattleScript_TailSlapEffect[];
...
extern const u8 BattleScript_TargetAbilityStatDropRet[];
