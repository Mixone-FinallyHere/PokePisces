...
extern const u8 BattleScript_TickedTurnDrainLiquidOoze[];
extern const u8 BattleScript_TickedTurnDrainHealBlock[];
extern const u8 BattleScript_TickedTurnDrainRecovery[];
