...
#define FLAG_GOT_ILLEGAL_TEACHY_TV    0x23 // Unused Flag
...
#define FLAG_BATTLE_MUSIC_OVERRIDE           0x68  // Unused Flag
...
#define FLAG_DEFEATED_GOLDEN_PLAINS_RIVAL         0x8D
...
#define FLAG_DEFEATED_OZONE_MAXIE_ARCHIE   0x9E
...
#define FLAG_DEFEATED_TWO_PISCES_LEGENDS               0x1C0
...
#define FLAG_P_ITEM_SOOTOPOLIS_CASTLE_CORAL_CROWN            (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_P_ITEM_SOOTOPOLIS_CASTLE_RARE_CANDY             (FLAG_HIDDEN_ITEMS_START + 0x01)
#define FLAG_P_ITEM_SOOTOPOLIS_CASTLE_DRAGON_FANG            (FLAG_HIDDEN_ITEMS_START + 0x02)
#define FLAG_P_ITEM_SOOTOPOLIS_CASTLE_RARE_BONE              (FLAG_HIDDEN_ITEMS_START + 0x03)
#define FLAG_P_ITEM_PIRATES_GROTTO_BIG_NUGGET                (FLAG_HIDDEN_ITEMS_START + 0x04)
#define FLAG_P_ITEM_PIRATES_GROTTO_CURSED_AMULET             (FLAG_HIDDEN_ITEMS_START + 0x05)
#define FLAG_P_ITEM_PIRATES_GROTTO_GOLD_TOOTH                (FLAG_HIDDEN_ITEMS_START + 0x06)
#define FLAG_P_ITEM_CHIMNEY_SPINDA_AREA_TM_GEO_PULSE         (FLAG_HIDDEN_ITEMS_START + 0x07)
#define FLAG_P_ITEM_ROUTE_126_ETHER                          (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_P_ITEM_ROUTE_126_POTION                         (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_P_ITEM_ROUTE_126_LURE_BALL                      (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_P_ITEM_ROUTE_126_STARDUST                       (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_P_ITEM_ROUTE_126_PP_UP                          (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_P_ITEM_ROUTE_126_MAGNET                         (FLAG_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_P_ITEM_SWELTORN_DESERT_TM_DRAGON_PULSE          (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_P_ITEM_SWELTORN_DESERT_HYPER_POTION             (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_P_ITEM_SWELTORN_DESERT_MAX_ETHER                (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_P_ITEM_SWELTORN_DESERT_DUST_GOGGLES             (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_P_ITEM_SWELTORN_DESERT_MAX_REVIVE               (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_P_ITEM_SWELTORN_DESERT_GOLD_TOOTH               (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_P_ITEM_SWELTORN_DESERT_CORAL_CROWN              (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_P_ITEM_SWELTORN_DESERT_FULL_HEAL                (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_P_ITEM_SWELTORN_DESERT_PP_MAX                   (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_P_ITEM_SWELTORN_DESERT_TM_FLAME_LASH            (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_P_ITEM_SWELTORN_DESERT_STARDUST                 (FLAG_HIDDEN_ITEMS_START + 0x18)
#define FLAG_P_ITEM_SWELTORN_PALACE_RARE_BONE                (FLAG_HIDDEN_ITEMS_START + 0x19)
#define FLAG_P_ITEM_SWELTORN_PALACE_NUGGET                   (FLAG_HIDDEN_ITEMS_START + 0x1A)
#define FLAG_P_ITEM_SWELTORN_PALACE_TM_WILLPOWER             (FLAG_HIDDEN_ITEMS_START + 0x1B)
#define FLAG_P_ITEM_SWELTORN_PALACE_BITTER_ROOT              (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_P_ITEM_SWELTORN_PALACE_OUTSIDE_ESCAPE_ROPE      (FLAG_HIDDEN_ITEMS_START + 0x1D)
#define FLAG_P_ITEM_SWELTORN_PALACE_OUTSIDE_TM_PSYSHOCK      (FLAG_HIDDEN_ITEMS_START + 0x1E)
#define FLAG_P_ITEM_SWELTORN_PALACE_OUTSIDE_RARE_CANDY       (FLAG_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_P_ITEM_SWELTORN_PALACE_OUTSIDE_LUXURY_BALL      (FLAG_HIDDEN_ITEMS_START + 0x20)
#define FLAG_P_ITEM_SWELTORN_PALACE_OUTSIDE_KINGS_ROCK       (FLAG_HIDDEN_ITEMS_START + 0x21)
#define FLAG_P_ITEM_MAUVILLE_NEW_GOLD_TOOTH                  (FLAG_HIDDEN_ITEMS_START + 0x22)
#define FLAG_P_ITEM_MAUVILLE_NEW_WIDE_LENS                   (FLAG_HIDDEN_ITEMS_START + 0x23)
#define FLAG_P_ITEM_MAUVILLE_NEW_GUARD_SPEC                  (FLAG_HIDDEN_ITEMS_START + 0x24)
#define FLAG_P_ITEM_MAUVILLE_NEW_TWISTED_SPOON               (FLAG_HIDDEN_ITEMS_START + 0x25)
#define FLAG_P_ITEM_MAUVILLE_NEW_ZOOM_LENS                   (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_P_ITEM_MAUVILLE_NEW_ABILITY_COOKIE              (FLAG_HIDDEN_ITEMS_START + 0x27)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_TM_SEED_BOMB             (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_CARROT_HORN_2            (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_TIMID_MINT               (FLAG_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_CARROT_HORN              (FLAG_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_PP_UP                    (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_MIRACLE_SEED             (FLAG_HIDDEN_ITEMS_START + 0x2D)
#define FLAG_P_ITEM_HATCHLOAM_FIELD_REVIVE                   (FLAG_HIDDEN_ITEMS_START + 0x2E)
#define FLAG_P_ITEM_CYCLING_ROAD_TERRAIN_COAT                (FLAG_HIDDEN_ITEMS_START + 0x2F)
#define FLAG_P_ITEM_CYCLING_ROAD_HYPER_POTION                (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_P_ITEM_CYCLING_ROAD_TM_RAZOR_WIND               (FLAG_HIDDEN_ITEMS_START + 0x31)
#define FLAG_P_ITEM_CYCLING_ROAD_MAX_ETHER                   (FLAG_HIDDEN_ITEMS_START + 0x32)
#define FLAG_P_ITEM_CYCLING_ROAD_TM_SHADOW_CLAW              (FLAG_HIDDEN_ITEMS_START + 0x33)
#define FLAG_P_ITEM_CYCLING_ROAD_X_SPEED                     (FLAG_HIDDEN_ITEMS_START + 0x34)
#define FLAG_P_ITEM_CYCLING_ROAD_SCOPE_LENS                  (FLAG_HIDDEN_ITEMS_START + 0x35)
#define FLAG_P_ITEM_CYCLING_ROAD_CARROT_HORN                 (FLAG_HIDDEN_ITEMS_START + 0x36)
#define FLAG_P_ITEM_SEA_MAUVILLE_ELIXIR                      (FLAG_HIDDEN_ITEMS_START + 0x37)
#define FLAG_P_ITEM_SEA_MAUVILLE_MAX_REPEL                   (FLAG_HIDDEN_ITEMS_START + 0x38)
#define FLAG_P_ITEM_MAINTENANCE_FAST_BALL                    (FLAG_HIDDEN_ITEMS_START + 0x39)
#define FLAG_P_ITEM_MAINTENANCE_BLACK_SLUDGE                 (FLAG_HIDDEN_ITEMS_START + 0x3A)
#define FLAG_P_ITEM_MAINTENANCE_TM_VENOSHOCK                 (FLAG_HIDDEN_ITEMS_START + 0x3B)
#define FLAG_P_ITEM_MAINTENANCE_METAL_COAT                   (FLAG_HIDDEN_ITEMS_START + 0x3C)
#define FLAG_P_ITEM_MAINTENANCE_DIRE_HIT                     (FLAG_HIDDEN_ITEMS_START + 0x3D)
#define FLAG_P_ITEM_MAINTENANCE_ULTRA_BALL                   (FLAG_HIDDEN_ITEMS_START + 0x3E)
#define FLAG_P_ITEM_NEW_MAUVILLE_INSIDE_TM_LUNGE             (FLAG_HIDDEN_ITEMS_START + 0x3F)
#define FLAG_P_ITEM_NEW_MAUVILLE_INSIDE_X_DEFENSE            (FLAG_HIDDEN_ITEMS_START + 0x40)
#define FLAG_P_ITEM_NEW_MAUVILLE_INSIDE_TM_IRON_HEAD         (FLAG_HIDDEN_ITEMS_START + 0x41)
#define FLAG_P_ITEM_NEW_MAUVILLE_INSIDE_MAX_REPEL            (FLAG_HIDDEN_ITEMS_START + 0x42)
#define FLAG_P_ITEM_VERDANTURF_NEW_CARROT_HORN               (FLAG_HIDDEN_ITEMS_START + 0x43)
#define FLAG_P_ITEM_VERDANTURF_NEW_RARE_CANDY                (FLAG_HIDDEN_ITEMS_START + 0x44)
#define FLAG_P_ITEM_VERDANTURF_NEW_LONELY_MINT               (FLAG_HIDDEN_ITEMS_START + 0x45)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_CAVE_SOFT_SAND       (FLAG_HIDDEN_ITEMS_START + 0x46)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_CAVE_X_ACCURACY      (FLAG_HIDDEN_ITEMS_START + 0x47)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_CAVE_ABILITY_COOKIE  (FLAG_HIDDEN_ITEMS_START + 0x48)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_CAVE_LAX_MINT        (FLAG_HIDDEN_ITEMS_START + 0x49)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_HALLWAY_TIMER_BALL   (FLAG_HIDDEN_ITEMS_START + 0x4A)
#define FLAG_P_ITEM_SWELTORN_TRANSITION_HALLWAY_QUICK_BALL   (FLAG_HIDDEN_ITEMS_START + 0x4B)
#define FLAG_P_ITEM_TRICK_HOUSE_MAIN_PORTION_FULL_HEAL       (FLAG_HIDDEN_ITEMS_START + 0x4C)
#define FLAG_P_ITEM_TRICK_HOUSE_LEVER_ROOMS_PP_MAX           (FLAG_HIDDEN_ITEMS_START + 0x4D)
#define FLAG_P_ITEM_TRICK_HOUSE_LEVER_ROOMS_X_ATTACK         (FLAG_HIDDEN_ITEMS_START + 0x4E)
#define FLAG_P_ITEM_TRICK_HOUSE_LEVER_ROOMS_GOLD_TOOTH       (FLAG_HIDDEN_ITEMS_START + 0x4F)
#define FLAG_P_ITEM_TRICK_HOUSE_DARK_ROOM_TM_FOUL_PLAY       (FLAG_HIDDEN_ITEMS_START + 0x50)
#define FLAG_P_ITEM_SOUTHERN_ISLAND_TM_ZEN_HEADBUTT          (FLAG_HIDDEN_ITEMS_START + 0x51)
#define FLAG_P_ITEM_SOUTHERN_ISLAND_MAX_REVIVE               (FLAG_HIDDEN_ITEMS_START + 0x52)
#define FLAG_P_ITEM_SLATEPORT_SHORE_MAX_POTION               (FLAG_HIDDEN_ITEMS_START + 0x53)
#define FLAG_P_ITEM_SLATEPORT_SHORE_MAX_ETHER                (FLAG_HIDDEN_ITEMS_START + 0x54)
#define FLAG_P_ITEM_NAVIGULF_WAVES_BRIGHT_POWDER             (FLAG_HIDDEN_ITEMS_START + 0x55)
#define FLAG_P_ITEM_NAVIGULF_WAVES_TM_AQUA_TAIL              (FLAG_HIDDEN_ITEMS_START + 0x56)
#define FLAG_P_ITEM_DEWFORD_NEW_CARROT_HORN                  (FLAG_HIDDEN_ITEMS_START + 0x57)
#define FLAG_P_ITEM_DEWFORD_NEW_BOXING_GLOVE                 (FLAG_HIDDEN_ITEMS_START + 0x58)
#define FLAG_P_ITEM_STRAE_SEAPATH_NUGGET                     (FLAG_HIDDEN_ITEMS_START + 0x59)
#define FLAG_P_ITEM_STRAE_SEAPATH_GOLD_TOOTH                 (FLAG_HIDDEN_ITEMS_START + 0x5A)
#define FLAG_P_ITEM_STRAE_SEAPATH_SHINY_STONE                (FLAG_HIDDEN_ITEMS_START + 0x5B)
#define FLAG_P_ITEM_STRAE_SEAPATH_SMOOTH_ROCK                (FLAG_HIDDEN_ITEMS_START + 0x5C)
#define FLAG_P_ITEM_STRAE_SEAPATH_X_SP_ATK                   (FLAG_HIDDEN_ITEMS_START + 0x5D)
#define FLAG_P_ITEM_SAILORS_PAUSE_TM_PHASE_FORCE             (FLAG_HIDDEN_ITEMS_START + 0x5E)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_THROAT_SPRAY         (FLAG_HIDDEN_ITEMS_START + 0x5F)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_TM_THROAT_CHOP       (FLAG_HIDDEN_ITEMS_START + 0x60)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_ABILITY_COOKIE       (FLAG_HIDDEN_ITEMS_START + 0x61)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_RED_CARD             (FLAG_HIDDEN_ITEMS_START + 0x62)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_TM_PSYCHIC           (FLAG_HIDDEN_ITEMS_START + 0x63)
#define FLAG_P_ITEM_SAILORS_PAUSE_SHIPS_MAX_POTION           (FLAG_HIDDEN_ITEMS_START + 0x64)
#define FLAG_P_ITEM_SHOAL_CAVE_NEW_FLOOR_1_RARE_CANDY        (FLAG_HIDDEN_ITEMS_START + 0x65)
#define FLAG_P_ITEM_SHOAL_CAVE_NEW_FLOOR_1_TM_ICICLE_CRASH   (FLAG_HIDDEN_ITEMS_START + 0x66)
#define FLAG_P_ITEM_SHOAL_CAVE_NEW_FLOOR_2_HEAVY_BALL        (FLAG_HIDDEN_ITEMS_START + 0x67)
#define FLAG_P_ITEM_SHOAL_CAVE_NEW_FLOOR_2_DAWN_STONE        (FLAG_HIDDEN_ITEMS_START + 0x68)
#define FLAG_P_ITEM_SHOAL_CAVE_NEW_FLOOR_2_ICY_ROCK          (FLAG_HIDDEN_ITEMS_START + 0x69)
#define FLAG_P_ITEM_NAVIGULF_UNDERWATER_CORAL_CROWN          (FLAG_HIDDEN_ITEMS_START + 0x6A)
#define FLAG_P_ITEM_NAVIGULF_UNDERWATER_TM_THUNDERBOLT       (FLAG_HIDDEN_ITEMS_START + 0x6B)
#define FLAG_P_ITEM_NAVIGULF_UNDERWATER_DUSK_BALL            (FLAG_HIDDEN_ITEMS_START + 0x6C)
#define FLAG_P_ITEM_STRAE_SEAPATH_UNDERWATER_CORRODE_MOD     (FLAG_HIDDEN_ITEMS_START + 0x6D)
#define FLAG_P_ITEM_STRAE_SEAPATH_UNDERWATER_PP_MAX          (FLAG_HIDDEN_ITEMS_START + 0x6E)
#define FLAG_P_ITEM_STRAE_SEAPATH_UNDERWATER_MAX_ELIXIR      (FLAG_HIDDEN_ITEMS_START + 0x6F)
...
#define FLAG_P_ITEM_STRAE_SEAPATH_UNDERWATER_CORAL_CROWN  0x27E
#define FLAG_P_ITEM_DETERMANITE_BEACH_CORAL_CROWN  0x27F
#define FLAG_P_ITEM_DETERMANITE_BEACH_COOL_BALL  0x280
#define FLAG_P_ITEM_DETERMANITE_BEACH_TM_DIRE_CLAW  0x281
#define FLAG_P_ITEM_DETERMANITE_BEACH_METRONOME  0x282
#define FLAG_P_ITEM_DETERMANITE_BEACH_BLACK_BELT  0x283
#define FLAG_P_ITEM_DETERMANITE_BEACH_MAX_ELIXIR  0x284
#define FLAG_P_ITEM_DETERMANITE_BEACH_X_SP_DEF  0x285
#define FLAG_P_ITEM_DETERMANITE_QUARRY_TM_ICE_BEAM  0x286
#define FLAG_P_ITEM_DETERMANITE_QUARRY_TM_FLAMETHROWER  0x287
#define FLAG_P_ITEM_DETERMANITE_QUARRY_LOVE_BALL  0x288
#define FLAG_P_ITEM_DETERMANITE_QUARRY_B1F_RARE_CANDY  0x289
#define FLAG_P_ITEM_DETERMANITE_QUARRY_B1F_PP_MAX  0x28A
#define FLAG_P_ITEM_DETERMANITE_QUARRY_B1F_HEAVY_BALL  0x28B
#define FLAG_P_ITEM_WISHWELL_OCEAN_QUIET_MINT  0x28C
#define FLAG_P_ITEM_WISHWELL_OCEAN_CARROT_HORN  0x28D
#define FLAG_P_ITEM_WISHWELL_OCEAN_LEFTOVERS  0x28E
#define FLAG_P_ITEM_WISHWELL_OCEAN_MYSTIC_WATER  0x28F
#define FLAG_P_ITEM_WISHWELL_OCEAN_ABILITY_COOKIE  0x290
#define FLAG_P_ITEM_RUSTBURG_WHARF_FULL_RESTORE  0x291
#define FLAG_P_ITEM_RUSTBURG_WHARF_MAX_ELIXIR  0x292
#define FLAG_P_ITEM_RUSTBURG_WHARF_MAX_REPEL  0x293
...
#define FLAG_P_ITEM_UNDURA_TUNNELS_DEEP_TM_PLAY_ROUGH  0x29C
#define FLAG_P_ITEM_UNDURA_TUNNELS_DEEP_STAR_PIECE  0x29D
#define FLAG_P_ITEM_UNDURA_TUNNELS_DEEP_BEAST_BALL  0x29E
#define FLAG_P_ITEM_MIDNEOR_FALLS_PP_MAX  0x29F
#define FLAG_P_ITEM_MIDNEOR_FALLS_RARE_CANDY  0x2A0
#define FLAG_P_ITEM_MIDNEOR_FALLS_DUSK_STONE  0x2A1
#define FLAG_P_ITEM_MIDNEOR_FALLS_STAR_PIECE  0x2A2
#define FLAG_P_ITEM_MIDNEOR_FALLS_MAX_REVIVE  0x2A3
#define FLAG_P_ITEM_MIDNEOR_FALLS_DREAM_BALL  0x2A4
#define FLAG_P_ITEM_MIDNEOR_FALLS_FULL_RESTORE  0x2A5
#define FLAG_P_ITEM_MIDNEOR_FALLS_COMET_SHARD  0x2A6
#define FLAG_P_ITEM_MIDNEOR_FALLS_MAX_ELIXIR  0x2A7
#define FLAG_P_ITEM_MIDNEOR_FALLS_TM_ZAP_CANNON  0x2A8
#define FLAG_P_ITEM_RUSTBORO_NEW_GOLD_TOOTH  0x2A9
#define FLAG_P_ITEM_RUSTBORO_NEW_ABILITY_COOKIE  0x2AA
#define FLAG_P_ITEM_PETALBURG_NEW_CLEAR_AMULET  0x2AB
#define FLAG_P_ITEM_PETALBURG_NEW_CALM_MINT  0x2AC
#define FLAG_P_ITEM_PETALBURG_WOODS_NEW_ABILITY_COOKIE  0x2AD
#define FLAG_P_ITEM_PETALBURG_WOODS_NEW_POKE_DOLL  0x2AE
#define FLAG_P_ITEM_PETALBURG_WOODS_NEW_STAR_PIECE  0x2AF
#define FLAG_P_ITEM_PETALBURG_WOODS_NEW_COVERT_CLOAK  0x2B0 
#define FLAG_P_ITEM_OLDALE_NEW_CARROT_HORN  0x2B1
#define FLAG_P_ITEM_NOVICE_WALK_FULL_RESTORE  0x2B2
#define FLAG_P_ITEM_NOVICE_WALK_A_THING  0x2B3
#define FLAG_P_ITEM_NOVICE_WALK_RARE_CANDY  0x2B4
#define FLAG_P_ITEM_NOVICE_WALK_LEVEL_BALL  0x2B5
#define FLAG_P_ITEM_NOVICE_WALK_MAX_ETHER  0x2B6
#define FLAG_P_ITEM_PENDING_DEV_PP_MAX  0x2B7
#define FLAG_P_ITEM_PENDING_DEV_ABILITY_GUARD  0x2B8
#define FLAG_P_ITEM_SOUTH_MOSSDEEP_FAIRY_FEATHER  0x2B9
#define FLAG_P_ITEM_CRIMNEY_CALDERA_HEAT_ROCK  0x2BA
#define FLAG_P_ITEM_METEOR_NADIR_DAMP_ROCK  0x2BB
...
#define FLAG_EVER_GRANDE_TRANSITION_CAVE_GOLD_TOOTH                 0x2D9
...
#define FLAG_P_ITEM_SOOTOPOLIS_GYM_REVIVE_1                               0x3DD
#define FLAG_P_ITEM_SOOTOPOLIS_GYM_REVIVE_2                               0x3DE
...
// Item Ball Flags
#define FLAG_P_ITEM_SKY_PILLAR_SODA_POP                             0x3E8
#define FLAG_P_ITEM_SKY_PILLAR_TINY_MUSHROOM                        0x3E9
#define FLAG_P_ITEM_SKY_PILLAR_INTERIOR_SODA_POP                    0x3EA
#define FLAG_P_ITEM_SKY_PILLAR_INTERIOR_REPEL                       0x3EB
#define FLAG_P_ITEM_SKY_PILLAR_INTERIOR_ANTIDODE                    0x3EC
#define FLAG_P_ITEM_SKY_PILLAR_INTERIOR_REPEL_2                     0x3ED
#define FLAG_P_ITEM_SKY_PILLAR_INTERIOR_SODA_POP_2                  0x3EE
#define FLAG_P_ITEM_FLOTSHORE_REPEL                                 0x3EF
#define FLAG_P_ITEM_FLOTSHORE_POKE_BALL                             0x3F0
#define FLAG_P_ITEM_FLOTSHORE_ORAN_BERRY                            0x3F1
#define FLAG_P_ITEM_FLOTSHORE_SODA_POP                              0x3F2
#define FLAG_P_ITEM_FLOTSHORE_ANTIDODE                              0x3F3
#define FLAG_P_ITEM_FLOTSHORE_PP_MAX                                0x3F4
#define FLAG_P_ITEM_BASALIN_COAST_POKE_BALL                         0x3F5
#define FLAG_P_ITEM_BASALIN_COAST_SODA_POP                          0x3F6
#define FLAG_P_ITEM_BASALIN_COAST_POTION                            0x3F7
#define FLAG_P_ITEM_BASALIN_COAST_ANTIDODE                          0x3F8
#define FLAG_P_ITEM_BASALIN_COAST_ICE_HEAL                          0x3F9
#define FLAG_P_ITEM_BASALIN_COAST_REPEL                             0x3FA
#define FLAG_P_ITEM_SOOTOPOLIS_NEW_SODA_POP                         0x3FB
#define FLAG_P_ITEM_SOOTOPOLIS_NEW_REVIVE                           0x3FC
#define FLAG_P_ITEM_SOOTOPOLIS_NEW_ICE_HEAL                         0x3FD
#define FLAG_P_ITEM_SOOTOPOLIS_NEW_TINY_MUSHROOM                    0x3FE
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_POKE_BALL                      0x3FF
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_AWAKENING                      0x400
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_REPEAT_BALL                    0x401
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_POTION                         0x402
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_REPEL                          0x403
#define FLAG_P_ITEM_MANGROTTO_TUNNEL_SILVER_POWDER                  0x404
#define FLAG_P_ITEM_COSMOSS_SPACE_CENTER_STARDUST                   0x405
#define FLAG_P_ITEM_MOSDEEP_PERSIM_BERRY                            0x406
#define FLAG_P_ITEM_MOSDEEP_REVIVE                                  0x407
#define FLAG_P_ITEM_MOSDEEP_STARDUST                                0x408
#define FLAG_P_ITEM_MOSDEEP_ETHER                                   0x409
#define FLAG_P_ITEM_MOSDEEP_FULL_HEAL                               0x40A
#define FLAG_P_ITEM_MOSDEEP_POTION                                  0x40B
#define FLAG_P_ITEM_MOSDEEP_REVIVE_2                                0x40C
#define FLAG_P_ITEM_ROUTE_125_REVIVE                                0x40D
#define FLAG_P_ITEM_ROUTE_125_SUPER_REPEL                           0x40E
#define FLAG_P_ITEM_ROUTE_125_PP_UP                                 0x40F
#define FLAG_P_ITEM_ROUTE_125_SHARP_BEAK                            0x410
#define FLAG_P_ITEM_NEW_SUNBEACH_SUPER_POTION                       0x411
#define FLAG_P_ITEM_NEW_SUNBEACH_BIG_MUSHROOM                       0x412
#define FLAG_P_ITEM_NEW_SUNBEACH_BLACK_GLASSES                      0x413
#define FLAG_P_ITEM_NEW_SUNBEACH_POKE_DOLL                          0x414
#define FLAG_P_ITEM_NEW_SUNBEACH_CORAL_CROWN                        0x415
#define FLAG_P_ITEM_NEW_SUNBEACH_PP_UP                              0x416
#define FLAG_P_ITEM_NEW_SUNBEACH_STAR_PIECE                         0x417
#define FLAG_P_ITEM_NEW_SUNBEACH_CORAL_CROWN_POST_SURF              0x418
#define FLAG_P_ITEM_LILYCOVE_PP_UP                                  0x419
#define FLAG_P_ITEM_LILYCOVE_ABILITY_COOKIE                         0x41A
#define FLAG_P_ITEM_LILYCOVE_REVIVE                                 0x41B
#define FLAG_P_ITEM_LILYCOVE_FULL_HEAL                              0x41C
#define FLAG_P_ITEM_LILYCOVE_OZONE_HQ_CELL_BATTERY                  0x41D
#define FLAG_P_ITEM_COLD_MINES_ICE_HEAL                             0x41E
#define FLAG_P_ITEM_COLD_MINES_POKE_DOLL                            0x41F
#define FLAG_P_ITEM_COLD_MINES_HARD_STONE                           0x420
#define FLAG_P_ITEM_COLD_MINES_NUGGET                               0x421
#define FLAG_P_ITEM_COLD_MINES_CORAL_CROWN                          0x422
#define FLAG_P_ITEM_COLD_MINES_SUPER_POTION                         0x423
#define FLAG_P_ITEM_ROUTE_121_PP_UP                                 0x424
#define FLAG_P_ITEM_ROUTE_121_NEVER_MELT_ICE                        0x425
#define FLAG_P_ITEM_ROUTE_121_CORAL_CROWN                           0x426
#define FLAG_P_ITEM_ROUTE_121_X_SPEED                               0x427
#define FLAG_P_ITEM_ROUTE_121_RELAXANT                              0x428
#define FLAG_P_ITEM_ROUTE_123_RARE_CANDY                            0x429
#define FLAG_P_ITEM_ROUTE_123_PP_UP                                 0x42A
#define FLAG_P_ITEM_ROUTE_123_ELIXIR                                0x42B
#define FLAG_P_ITEM_ROUTE_123_X_SP_ATK                              0x42C
#define FLAG_P_ITEM_ROUTE_123_RELAXANT                              0x42D
#define FLAG_P_ITEM_MT_PYRE_1F_SPELL_TAG                            0x42E
#define FLAG_P_ITEM_MT_PYRE_1F_SUPER_POTION                         0x42F
#define FLAG_P_ITEM_MT_PYRE_1F_POKE_DOLL                            0x430
#define FLAG_P_ITEM_MT_PYRE_1F_MAX_ETHER                            0x431
#define FLAG_P_ITEM_MT_PYRE_2F_CORAL_CROWN                          0x432
#define FLAG_P_ITEM_MT_PYRE_2F_GUARD_SPEC                           0x433
#define FLAG_P_ITEM_MT_PYRE_2F_X_SP_DEF                             0x434
#define FLAG_P_ITEM_MT_PYRE_2F_PP_UP                                0x435
#define FLAG_P_ITEM_ROUTE_122_REVIVE                                0x436
#define FLAG_P_ITEM_ARCTAIGA_SPINDA_DEN_ICE_STONE                   0x437
#define FLAG_P_ITEM_ARCTAIGA_SPINDA_DEN_MAX_REVIVE                  0x438
#define FLAG_P_ITEM_ROUTE_120_ESCAPE_ROPE                           0x439
#define FLAG_P_ITEM_ROUTE_120_PROTECT_PADS                          0x43A
#define FLAG_P_ITEM_ROUTE_120_CARROT_HORN                           0x43B
#define FLAG_P_ITEM_ROUTE_120_X_DEFENSE                             0x43C
#define FLAG_P_ITEM_ROUTE_120_SERIOUS_MINT                          0x43D
#define FLAG_P_ITEM_ROUTE_120_CHARCOAL                              0x43E
#define FLAG_P_ITEM_ROUTE_120_TM_RETALIATE                          0x43F
#define FLAG_P_ITEM_ROUTE_120_PP_UP                                 0x440
#define FLAG_P_ITEM_SCUTTILL_HUTS_SUPER_POTION                      0x441
#define FLAG_P_ITEM_SCUTTILL_HUTS_MAX_REPEL                         0x442
#define FLAG_P_ITEM_SCUTTILL_HUTS_MAX_ETHER                         0x443
#define FLAG_P_ITEM_SCUTTILL_HUTS_PP_UP                             0x444
#define FLAG_P_ITEM_SCUTTILL_HUTS_TM_STICKY_WEB                     0x445
#define FLAG_P_ITEM_SCUTTILL_HUTS_BIG_MUSHROOM                      0x446
#define FLAG_P_ITEM_SCUTTILL_HUTS_PESKY_PLUSH                       0x447
#define FLAG_P_ITEM_SCUTTILL_HUTS_ABILITY_COOKIE                    0x448
#define FLAG_P_ITEM_SCUTTILL_HUTS_REVIVE                            0x449
#define FLAG_P_ITEM_SCUTTILL_HUTS_ESCAPE_ROPE                       0x44A
#define FLAG_P_ITEM_CANOPOUR_WILDS_FULL_HEAL                        0x44B
#define FLAG_P_ITEM_CANOPOUR_WILDS_CORAL_CROWN                      0x44C
#define FLAG_P_ITEM_CANOPOUR_WILDS_QUICK_CLAW                       0x44D
#define FLAG_P_ITEM_CANOPOUR_WILDS_TM_HYPER_VOICE                   0x44E
#define FLAG_P_ITEM_PERPLUME_MAZE_ADAMANT_MINT                      0x44F
#define FLAG_P_ITEM_PERPLUME_MAZE_CARROT_HORN                       0x450
#define FLAG_P_ITEM_PERPLUME_MAZE_TM_THUNDER_WAVE                   0x451
#define FLAG_P_ITEM_PERPLUME_MAZE_MAX_REPEL                         0x452
#define FLAG_P_ITEM_PERPLUME_MAZE_CHUPACABRA                        0x453
#define FLAG_P_ITEM_PERPLUME_MAZE_DIRE_HIT                          0x454
#define FLAG_P_ITEM_PERPLUME_MAZE_X_ATTACK                          0x455
#define FLAG_P_ITEM_SCUTTILL_SECRET_TREE_HOUSE_NEST_BALL            0x456
#define FLAG_P_ITEM_CANOPOUR_BUSHES_BIG_ROOT                        0x457
#define FLAG_P_ITEM_CANOPOUR_BUSHES_TM_ROCK_SLIDE                   0x458
#define FLAG_P_ITEM_OZONE_INSTITUTE_BIG_MUSHROOM                    0x459
#define FLAG_P_ITEM_OZONE_INSTITUTE_HYPER_POTION                    0x45A
#define FLAG_P_ITEM_OZONE_INSTITUTE_GOLD_TOOTH                      0x45B
#define FLAG_P_ITEM_MASONRIED_HIKE_TM_GYRO_BALL                     0x45C
#define FLAG_P_ITEM_MASONRIED_HIKE_LIGHT_CLAY                       0x45D
#define FLAG_P_ITEM_MASONRIED_HIKE_MODEST_MINT                      0x45E
#define FLAG_P_ITEM_MASONRIED_HIKE_X_SP_ATK                         0x45F
#define FLAG_P_ROUTE_113_GOLD_TOOTH                                 0x460
#define FLAG_P_ROUTE_113_MAX_REPEL                                  0x461
#define FLAG_P_ROUTE_113_TM_GLACIATE                                0x462
#define FLAG_P_ROUTE_113_TM_ABILITY_COOKIE                          0x463
#define FLAG_P_ROUTE_113_TM_THUNDER_STONE                           0x464
#define FLAG_P_ROUTE_113_CARROT_HORN                                0x465
#define FLAG_P_ROUTE_113_NUGGET                                     0x466
#define FLAG_P_ROUTE_113_PP_UP                                      0x467
#define FLAG_P_ROUTE_113_TM_FLORESCENCE                             0x468
#define FLAG_P_CRIMNEY_CLIMB_ROCKY_HELMET                           0x469
#define FLAG_P_CRIMNEY_CLIMB_ABILITY_COOKIE                         0x46A
#define FLAG_P_CRIMNEY_CLIMB_TM_DAZZLE_GLEAM                        0x46B
#define FLAG_P_CRIMNEY_CLIMB_RARE_CANDY                             0x46C
#define FLAG_P_CRIMNEY_CLIMB_X_SPEED                                0x46D
#define FLAG_P_CRIMNEY_CLIMB_AIR_BALLOON                            0x46E
#define FLAG_P_CRIMNEY_CLIMB_GOLD_TOOTH                             0x46F
#define FLAG_P_CRIMNEY_CLIMB_NUGGET                                 0x470
#define FLAG_P_CRIMNEY_CLIMB_CORAL_CROWN                            0x471
#define FLAG_P_JAGGRO_PASS_GOLD_TOOTH                               0x472
#define FLAG_P_JAGGRO_PASS_TM_KNOCK_OFF                             0x473
#define FLAG_P_JAGGRO_PASS_PP_UP                                    0x474
#define FLAG_P_JAGGRO_PASS_ROOM_EXTENDER                            0x475
#define FLAG_P_JAGGRO_PASS_HYPER_POTION                             0x476
#define FLAG_P_JAGGRO_PASS_X_DEFENSE                                0x477
#define FLAG_P_JAGGRO_PASS_FULL_HEAL                                0x478
#define FLAG_P_JAGGRO_PASS_JOLLY_MINT                               0x479
#define FLAG_P_FALLARBOR_NEW_SERIOUS_MINT                           0x47A
#define FLAG_P_FALLARBOR_NEW_CARROT_HORN                            0x47B
#define FLAG_P_FALLARBOR_NEW_MAX_ELIXIR                             0x47C
#define FLAG_P_WHISPER_CLIFF_TM_AURA_SPHERE                         0x47D
#define FLAG_P_MIDNEOR_FALLS_CAVE_TM_DARK_PULSE                     0x47E
#define FLAG_P_MIDNEOR_FALLS_CAVE_TM_DUSK_BALL                      0x47F
#define FLAG_P_MIDNEOR_FALLS_CAVE_MOON_STONE                        0x480
#define FLAG_P_MIDNEOR_FALLS_CAVE_ORBIT_BALL                        0x481
#define FLAG_P_MIDNEOR_FALLS_CAVE_STAR_PIECE                        0x482
#define FLAG_P_FIERY_PATH_PP_UP                                     0x483
#define FLAG_P_FIERY_PATH_CORAL_CROWN                               0x484
#define FLAG_P_FIERY_PATH_CORAL_CROWN_3                             0x485
#define FLAG_P_FIERY_PATH_ASSAULT_VEST                              0x486
#define FLAG_P_FIERY_PATH_RARE_BONE                                 0x487
#define FLAG_P_FIERY_PATH_ESCAPE_ROPE                               0x488
#define FLAG_P_FIERY_PATH_TM_BRICK_BREAK                            0x489
#define FLAG_P_FIERY_PATH_DIRE_HIT                                  0x48A
#define FLAG_P_FIERY_PATH_FULL_HEAL                                 0x48B
#define FLAG_P_FIERY_PATH_CORAL_CROWN_2                             0x48C
#define FLAG_P_LAVARIDGE_INT_ABILITY_COOKIE                         0x48D
#define FLAG_P_LAVARIDGE_INT_X_SPDEF                                0x48E
#define FLAG_P_LAVARIDGE_INT_CAREFUL_MINT                           0x48F
#define FLAG_P_LAVARIDGE_INT_MAX_ETHER                              0x490
#define FLAG_P_LAVARIDGE_INT_TM_BODY_SLAM                           0x491
#define FLAG_P_LAVARIDGE_INT_POISON_BARB                            0x492
...
#define FLAG_GOT_FAVOR_SCARF                                           0x4D3 // Unused Flag
#define FLAG_JUDGED_PAINTING                                           0x4D4 // Unused Flag
...
#define FLAG_EVER_GRANDE_TRANSITION_CAVE_FULL_RESTORE               0x4E0
#define FLAG_EVER_GRANDE_ROAD_GOLD_BALL_2                           0x4E1
#define FLAG_EVER_GRANDE_ROAD_TM_RAGING_FURY                        0x4E2
#define FLAG_EVER_GRANDE_ROAD_GOLD_BALL                             0x4E3
#define FLAG_EVER_GRANDE_ROAD_PP_MAX                                0x4E4
#define FLAG_EVER_GRANDE_ROAD_BIG_NUGGET                            0x4E5
#define FLAG_EVER_GRANDE_ROAD_CORAL_CROWN                           0x4E6
#define FLAG_EVER_GRANDE_ROAD_CARROT_HORN                           0x4E7
#define FLAG_EVER_GRANDE_ROAD_MAX_ELIXIR                            0x4E8
...
#define FLAG_EGR_NO_FLY                           (SYSTEM_FLAGS + 0x24) // Unused Flag
